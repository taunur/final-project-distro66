...
const LinkTabs = (props) => {
  ...
  return (
    <div className="p-6 hover:text-black transition-all ease-in-out duration-300">
          ...
          <div className="container-navbar flex justify-between items-center">
            <div className="flex flex-row justify-between w-full">
              <div className="flex flex-row">
                <LinkTabs link="/" label="Distro66" activeLink="" />
                <LinkTabs link="/" label="Home" activeLink="text-black" />
              ...
              {user === null ? (
                <LinkTabs link="/login" label="Login" activeLink="text-black" />
              ) : (
                <div className="flex">
                  {user?.email === "admin@bukapedia.com" ? (
                    <div className="p-6 hover:text-black transition-all ease-in-out duration-300">
                    ...
                    <>
                      <div className="p-6 hover:text-black transition-all ease-in-out duration-300 cursor-pointer">
                        <NavLink exact to="/cart" activeClassName="text-black">
